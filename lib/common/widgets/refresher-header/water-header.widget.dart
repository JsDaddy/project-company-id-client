      ...
      child: ScaleTransition(
        ...
        child: Align(
          ...
          child: RefreshProgressIndicator(
            ...
            value: (floating != null || floating != false)
                ? null
                : _valueAni.value,
...
class CustomWaterHeader extends MaterialClassicHeader {
  const CustomWaterHeader({
    Key key,
  ...
  @override
  State<StatefulWidget> createState() {
    return _CustomWaterHeaderState();
  }
}

class _CustomWaterHeaderState extends _MaterialClassicHeaderState {
